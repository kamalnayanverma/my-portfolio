...
const WORDS = ["Hi, I'm Kamal Nayan Verma","Computer Science Student", "Tech Enthusiast","Crafting Code"];
const TECH_STACK = ["Power Bi","Tableau", "Excel", "Sql"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/kamalnayanverma" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/kamal-nayan-verma-118543252/" },
  { icon: Instagram, link: "https://www.instagram.com/kamalverma9678/" }
];
